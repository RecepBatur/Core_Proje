...
namespace DataAccessLayer.EntityFramework
{
    public class EfUserMessageDal : GenericRepository<UserMessage>, IUserMessageDal
    {
        public List<UserMessage> GetUserMessageWithUser()
        {
            ...
            {
                //include metodunu kullanarak user tablosunu da listeleyebiliyoruz. UserMessage tablosunu kullandığımız yerlerde user tablosundaki propertyleri kullanmaya yarıyor.
